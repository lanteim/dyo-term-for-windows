...
window.I18N.register({
    en: { "widget.ref_tmuxcheat": "tmux Cheat-Sheet", "cat.reference": "Reference" },
    ru: { "widget.ref_tmuxcheat": "tmux шпаргалка", "cat.reference": "Справочник" }
});
window.WIDGETS = window.WIDGETS || {};

window.WIDGETS.ref_tmuxcheat = {
    id: "ref_tmuxcheat",
    title: "widget.ref_tmuxcheat",
    category: "reference",
    description: "tmux cheat-sheet, searchable; click to copy",
    defaultSize: { w: 8, h: 5 },
    mount(body) {
        ...
        window.__refCheatRender(body, DATA, esc, "Search tmux keys…");
